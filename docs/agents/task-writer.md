...
2. **If the problem queue is empty, advance the roadmap by one
...
`grep -rn "\.rs:[0-9]" docs docs/agent-guide.md` over the whole tree and
...
`docs/agent-guide.md`, and writing it there is the Architect's. Flag it rather than
