...
fn sample_errors() -> Vec<Error> {
    vec![
        ...
        Error::BufferPoolWaitTimedOut { waited_ms: 30_000 },
        ...
        Error::ParameterCountMismatch { expected: 1, found: 2 },
        Error::UndefinedTable { name: "missing".to_string() },
        Error::UndefinedColumn { name: "ghost".to_string() },
        Error::UndefinedFunction { name: "now".to_string() },
        Error::UndefinedParameter { index: 1 },
